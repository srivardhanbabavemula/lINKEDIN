...
def _fallback_message(profile: dict[str, Any], first_name: str) -> str:
    ...
    parts.append(
        f"I'm a student at {MY_SCHOOL} pursuing {MY_DEGREE}, and I'm exploring "
        f"internships, co-op programs, and full-time opportunities. "
        f"Your career path at {profile.get('company', 'your company')} stood out to me, "
        f"and I'd appreciate any advice you might share."
    )
